...
module.exports = {
	up: async (queryInterface, Sequelize) => {
		let notificationTemplateData = [
			{
				body: '<p>Dear {name},</p><p>Your bulk upload is successfully completed. Please download the CSV of the report using the link provided below:</p><p>Link <a href="{file_link}" target="_blank">here</a></p>.',
